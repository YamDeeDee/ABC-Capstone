...
user_prompt = form.text_area("Ask me anything related to Agency for Integrated Care e.g. I am a caregiver for a parent with dementia. How do I get help?", height=100)
